        ...
        <div
            ...
            <div class="flex gap-2">
                ...
                <div class="flex flex-col items-start">
                    <span class="font-semibold"><?php if(isset($_GET['username'])){
                        echo htmlspecialchars($_GET['username']) ;
                        }
                        ?></span>
                    <span><?php if(isset($_GET['email'])){
            ...
            <div class="flex justify-between w-full px-8">
                ...
                <span name="namebox"><?php if(isset($_GET['username'])){
                        echo htmlspecialchars($_GET['username']) ;
                        }
                        ?></span>
            </div>
            ...
            <div class="flex justify-between w-full px-8">
                ...
                <span name="emailbox"><?php if(isset($_GET['email'])){
                        echo htmlspecialchars($_GET['email']) ;
                        }
                        ?></span>
            </div>
            ...
            <div class="flex justify-between w-full px-8">
                ...
                <span name="numberbox"><?php if(isset($_GET['email'])){
            ...
            <div class="flex justify-between w-full px-8">
                ...
                <span name="locationbox"><?php if(isset($_GET['email'])){
